	...
	<div class="container">
		<div class="row align-items-center g-5">
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<h1 class="mb-0 display-6">Grile, cursuri, teste și simulari pentru
					<span class="position-relative">rezidentiat
				...
				<p class="my-4 lead">Organizam in fiecare saptamana simulari pentru a te mentine conectat si pentru a iti oferi un program de studiu. Cu un cont premium, poti avea acces la toata simularile de etapa anterioare!
				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					<!-- Button -->
					<a href="#" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">Sa incepem!</a>
					<!-- Video button -->
					<div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
						<a data-glightbox data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7"> 
							...
							<h6 class="mb-0 ms-3 fw-normal position-absolute start-100 top-50 translate-middle-y">Vizualizeaza video</h6>
						</a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				...
				<div class="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="text-start ms-3">
							<h6 class="mb-0 text-white">Felicitari! <span class="ms-4"><i class="fas fa-check-circle text-success"></i></span></h6>
							<p class="mb-0 small text-white">Punctajul tau tocmai s-a afisat!</p>
						</div>
					</div>
				</div>
				...
				<div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
					<p class="text-white">Noi nostrii studenti:</p>
					<!-- Avatar group -->
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="100"	data-purecounter-delay="200"></h5>
							<span class="mb-0 h5"></span>
						</div>
						<p class="mb-0">Cursuri online</p>
					</div>
				</div>
			</div>
			<!-- Counter item -->
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="1000" data-purecounter-delay="200">0</h5>
							<span class="mb-0 h5">+</span>
						</div>
						<p class="mb-0">Rezidenti admisi</p>
					</div>
				</div>
			</div>
			<!-- Counter item -->
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						<div class="d-flex">
							<h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="8000" data-purecounter-delay="300">0</h5>
							<span class="mb-0 h5">+</span>
						</div>
						<p class="mb-0">Grile</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-1">Ultimele noutati</h2>
			</div>
		</div>
		<ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-1" type="button" role="tab" aria-controls="course-pills-tabs-1" aria-selected="false">Simulari saptamanale</button>
			</li>
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-2" type="button" role="tab" aria-controls="course-pills-tabs-2"	aria-selected="false">Cursuri</button>
			</li>
		</ul>
		...
		<div class="tab-content" id="course-pills-tabContent">
				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<img src="{{ url('/') }}/assets/images/course.png" class="card-img-top" alt="Course image">
							<div class="card-body pb-0">
								<h5 class="card-title fw-normal"><a href="#">Curs diabet zaharat</a></h5>
								<p class="mb-2 text-truncate-2">Acest curs contine toate informatiile despre diabetul zaharat.</p>
							...
							<div class="card-footer pt-0 pb-3">
								...
								<div class="d-flex justify-content-between">
									<span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>194 pagini</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<img src="{{ url('/') }}/assets/images/exam.png" class="card-img-top" alt="Course image">
							<div class="card-body pb-0">
								<h5 class="card-title fw-normal"><a href="#">Simulare final de etapa</a></h5>
								<p class="mb-2 text-truncate-2">Aceasta simulare va avea loc pe data de 04.02.2023 - 12:30</p>
							</div>
							<div class="card-footer pt-0 pb-3">
								<hr>
								<div class="d-flex justify-content-between">
									<span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>30 grile</span>
								</div>
							</div>
						</div>
					</div>
